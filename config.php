...
// var_dump($ip_addr); die();
// $config['base_url'] = 'http://192.168.88.45/chepsoo/';
...
$config['branch_name'] = 'ASTER HEALTH CENTER';
$config['sender_email'] = 'info@aster-health.com';
$config['recepients_email'] = '';

$config['credit_note_id'] = 83;
$config['credit_note_supplies'] = 84;
$config['creditor_invoice'] = 88;

// hjerutocheruiyot@gmail.com
